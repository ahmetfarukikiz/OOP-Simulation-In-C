...
derle:
	gcc -I ./include/ -o ./lib/YazdirServis.o -c ./src/servisler/YazdirServis.c
	...
	gcc -I ./include/ -o ./bin/program.exe ./lib/YazdirServis.o ./lib/SahteVeriUretici.o ./lib/BaslangicKuralHesaplayici.o ./lib/BaslangicGirdiIslemleri.o ./lib/Ilce.o ./lib/Kisi.o ./lib/Mahalle.o ./lib/Sehir.o ./lib/Yerlesim.o ./lib/Oyun.o ./lib/OyunBaslaticiServis.o ./src/main/Main.c
