...
derle:
	...
	gcc -I ./include/ -o ./bin/program.exe ./lib/BaslangicGirdiIslemleri.o ./lib/Ilce.o ./lib/Kisi.o ./lib/Mahalle.o ./lib/Sehir.o ./lib/Yerlesim.o ./lib/Oyun.o ./lib/OyunBaslaticiServis.o ./src/main/Main.c
